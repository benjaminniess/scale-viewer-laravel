    ...
    <div class="container main-container">
        ...
        <form method="POST" action="/board">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Enter your board name" name="title" id="board-title">
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea" name="description" id="board-description"></textarea>
                </div>
